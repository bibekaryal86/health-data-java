...
public class DatasourceConfig {
  ...
  public DataSource dataSource() {
    String url =
        "jdbc:db2://%s.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:%s/bludb:sslConnection=true;";
    ...
    dataSource.setUsername(
        CommonUtils.getSystemEnvProperty(ConstantUtils.DB2_USERNAME, "db2UserNameError"));
    dataSource.setPassword(
        CommonUtils.getSystemEnvProperty(ConstantUtils.DB2_PASSWORD, "db2PasswordError"));
  ...
  private Properties additionalJpaProperties() {
    ...
    properties.setProperty(
        "hibernate.hbm2ddl.auto", this.environment.getProperty("spring.jpa.hibernate.ddl-auto"));
    properties.setProperty(
        "hibernate.dialect",
        this.environment.getProperty("spring.jpa.properties.hibernate.dialect"));
    properties.setProperty(
        "hibernate.current_session_context_class",
        this.environment.getProperty(
            "spring.jpa.properties.hibernate.current_session_context_class"));
    properties.setProperty(
        "hibernate.show_sql", this.environment.getProperty("spring.jpa.show-sql"));
    properties.setProperty(
        "hibernate.format_sql",
        this.environment.getProperty("spring.jpa.properties.hibernate.format_sql"));
    return properties;
  }
}
