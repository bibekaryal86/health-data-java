...
public class ConstantUtils {
  ...
  public static final String ERR_MSG_FIND =
      "Error Retrieving Objects from Database! Please Try Again!!!";
  public static final String ERR_MSG_SAVE = "Error Saving Object to Database! Please Try Again!!!";
  public static final String ERR_MSG_DELETE =
      "Error Deleting Object from Database! Please Try Again!!!";
  public static final String ERR_MSG_MISSING =
      "Error! Required Input Missing or Invalid!! Please Try Again!!!";

  public static final List<String> RESULT_FLAG_INVERSE_LIST =
      List.of("HDL CHOLESTEROL", "EGFR NOT AFRICAN", "EGFR AFRICAN");
}
