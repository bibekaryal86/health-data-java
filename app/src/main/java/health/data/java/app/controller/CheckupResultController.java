...
public class CheckupResultController {
  ...
  public ResponseEntity<CheckupResultResponse> insert(
      @RequestBody CheckupResultRequest checkupResultRequest) {
    if (checkupResultService.isValidCheckupResultRequest(checkupResultRequest, true)) {
      return response(
          checkupResultService.saveCheckupResult(checkupResultRequest.getCheckupResult()));
    }
  ...
  public ResponseEntity<CheckupResultResponse> update(
      @RequestBody CheckupResultRequest checkupResultRequest) {
  ...
  private ResponseEntity<CheckupResultResponse> response(
      CheckupResultResponse checkupCategoryResponse) {
