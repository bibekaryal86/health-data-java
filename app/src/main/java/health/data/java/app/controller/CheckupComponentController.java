...
public class CheckupComponentController {
    ...
    public ResponseEntity<CheckupComponentResponse> insert(@RequestBody CheckupComponentRequest checkupComponentRequest) {
        if (checkupComponentService.isValidCheckupComponentRequest(checkupComponentRequest, true)) {
            ResponseEntity<CheckupComponentResponse> responseEntity = response(checkupComponentService.saveCheckupComponent(
    ...
    public ResponseEntity<CheckupComponentResponse> update(@RequestBody CheckupComponentRequest checkupComponentRequest) {
    ...
    private ResponseEntity<CheckupComponentResponse> response(CheckupComponentResponse checkupCategoryResponse) {
    ...
    private ResponseEntity<CheckupComponentResponse> badRequestResponse() {
        return new ResponseEntity<>(CheckupComponentResponse.builder()
