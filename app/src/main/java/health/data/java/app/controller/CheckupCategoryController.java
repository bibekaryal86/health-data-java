...
public class CheckupCategoryController {
    ...
    public ResponseEntity<CheckupCategoryResponse> insert(@RequestBody CheckupCategoryRequest checkupCategoryRequest) {
        if (checkupCategoryService.isValidCheckupCategoryRequest(checkupCategoryRequest, true)) {
            ResponseEntity<CheckupCategoryResponse> responseEntity = response(checkupCategoryService.saveCheckupCategory(
    ...
    public ResponseEntity<CheckupCategoryResponse> update(@RequestBody CheckupCategoryRequest checkupCategoryRequest) {
    ...
    private ResponseEntity<CheckupCategoryResponse> response(CheckupCategoryResponse checkupCategoryResponse) {
    ...
    private ResponseEntity<CheckupCategoryResponse> badRequestResponse() {
        return new ResponseEntity<>(CheckupCategoryResponse.builder()
